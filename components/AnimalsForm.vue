  ...
  >
    <div class="bg-white p-6 rounded-lg w-96">
      ...
      <form @submit.prevent="submitForm">
        ...
        <div class="mb-4">
          <label for="localNascimento" class="block text-sm font-medium text-gray-700">Local de Nascimento</label>
          <input v-model="formData.localNascimento" type="text" id="localNascimento" class="w-full p-2 border rounded-md" />
        </div>
        <div class="mb-4">
          <label for="pai" class="block text-sm font-medium text-gray-700">Pai</label>
          <input v-model="formData.pai" type="text" id="pai" class="w-full p-2 border rounded-md" />
        </div>
        <div class="mb-4">
          <label for="comprado" class="block text-sm font-medium text-gray-700">Origem</label>
